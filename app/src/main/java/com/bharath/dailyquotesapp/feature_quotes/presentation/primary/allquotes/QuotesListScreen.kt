...
@Composable
fun ShareComposableAsImage(content: @Composable () -> Unit) {
//    val bitmap =
}

//fun captureBitMap(content: @Composable () -> Unit, density: Float): Bitmap {
//    val width = (300.dp * density).value.toInt()
//    val height = (400.dp * density).value.toInt()
